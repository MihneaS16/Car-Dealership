...
export default function CarDetails({ removeCar, removeServiceRecord }) {
  ...
  useEffect(() => {
    ...
    const fetchServiceRecords = async () => {
      try {
        const fetchedServiceRecords =
          await serviceRecordService.getAllserviceRecordsForCar(id);
  ...
  return (
    <div className="CarDetails">
      {car === undefined ? (
        <h1>The car you're looking for doesn't exist</h1>
      ) : (
        <div>
          <div className="Car">
            ...
            <span className="Buttons">
              ...
              <button
                onClick={() => navigateTo(`/cars/edit/${car._id}`)}
          ...
          <div className="ServiceRecords">
            ...
            ></ServiceRecordList>
            <button
              onClick={() => navigateTo(`/cars/${car._id}/serviceRecords/add`)}
            >
              Add Service Record
            </button>
          </div>
      ...
      <a className="Back-Link" href="/cars">
        Go Back
      </a>
    </div>
  );
