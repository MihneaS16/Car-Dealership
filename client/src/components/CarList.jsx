  ...
  return (
    <div className="Cars">
      ...
      <header className="Header">
        ...
        <button onClick={toggleShowing} className="BulkDelete">
          {isShowing ? "Cancel" : "Bulk Delete"}
        </button>
        <CSVLink className="CSVLink" data={cars}>
          Download cars data
        </CSVLink>
      </header>
      ...
      <ul className="CarList">
        {cars.map((car) => (
          <li key={car._id} className="CarList-Item">
            ...
            <input
              type="checkbox"
              className={isShowing ? "ShowCheckbox" : "HideCheckbox"}
              checked={selectedCars.includes(car._id)}
              onChange={() => handleCheck(car._id)}
            />
          </li>
        ))}
      ...
      <footer className="Footer">
        <a className="AddCar" href="/cars/add">
          Add Car
        </a>
      </footer>
    </div>
