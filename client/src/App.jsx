...
export default function App() {
  ...
  const sortCars = () => {
    ...
    const fetchSorted = async () => {
      const sortedCars = await carService.getAllCars(
        currentPage,
        itemsPerPage,
        sort,
      );
  ...
  const deleteSelected = (selectedCars) => {
    ...
    setCars((prevCars) =>
      prevCars.filter((car) => !selectedCars.includes(car._id)),
    );
  };
    ...
    <Router>
      <div className="content">
        <Routes>
          ...
          <Route
            path="/login"
            element={<UserLoginForm loginUser={loginUser} />}
          />
          <Route
            path="/register"
            element={<UserRegisterForm registerUser={registerUser} />}
          />
          <Route
            path="/cars"
            element={
          ...
          <Route
            path="/cars/edit/:id"
            element={<CarEditForm cars={cars} updateCar={updateCar} />}
          />
          <Route path="/cars/add" element={<CarAddForm addCar={addCar} />} />
          <Route
            path="/cars/:id/serviceRecords/add"
            element={
              <ServiceRecordAddForm addServiceRecord={addServiceRecord} />
            }
          />
          <Route
            path="/cars/:id/serviceRecords/edit/:serviceRecordId"
            element={
